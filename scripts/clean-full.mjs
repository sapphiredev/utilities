...
const paths = [
	...
	new URL('iterator-utilities/node_modules/', packagesDir),
	...
	new URL('string-store/node_modules/', packagesDir),
	...
	new URL('iterator-utilities/dist/', packagesDir),
	...
	new URL('string-store/dist/', packagesDir),
