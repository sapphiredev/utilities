...
export interface PaginatedMessageOptions {
	...
	/**
	 * The amount of milliseconds to wait before the paginator is closed.
	 * @default 1000 * 60 * 14.5
	 *
	 * @remark The default is to ensure that the paginator is closed before interactions expire.
	 */
